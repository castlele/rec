...
# Актуальность и цель работы (refactor)

Актуальность данной темы обусловлена такими причинами, как:
1. В современном мире, большая часть людей имеет при себе
мобильный телефон. Это мощнейший компьютер, способный производить
невероятные по сложности вычисления. С такими условиями потенциально
можно говорить о замене дорогостоящего оборудования кадастровых
инженеров на мобильное программное обеспечение.
2. Отказ от специальных устройств для проведения замеров и прочих
работ в пользу мобильных телефонов так же может оказать и колоссальное
влияние на остальные этапы работы инженеров при проведении
кадастровых работ. Ведь телефоны будут способны не только отображать
информацию, но и хранить ее, визуализировать в необходимом формате и
даже прямо при обмерах составлять технический план. Это приведет к
экономии времени кадастровых инженеров.
3. Использование современных технологий часто влечет за собой
появление новых кадров как на рынке труда, так и в университетах. Ведь
падает не только цена проведения работ, но и цена обучения – больше
людей смогут себе позволить обучиться интересующей их профессии.
4. Сейчас, когда искусственный интеллект захватывает все больше сфер
и все больше развивается, он показал, что работа, которую может
выполнить только человек будет невероятно ценна. Цена человеческого
ресурса будет расти. Так что точечное улучшение технологий и
усовершенствование процессов, будет способствовать смещению фокуса на
другие дела, что должно благоприятно сказаться на общем качестве
выполняемых кадастровыми инженерами работ.
5. В России дополненная реальность не пользуется спросом в сфере
кадастра недвижимости. Данная область не исследована.
...
# Анализ нормативно-правовых документов регулирующих осуществление кадастровой деятельности
...
# Основы постановки на кадастровый учет объектов капитального строительства
...
|Содержание графической части|схема геодезический построений, схема расположение земельных участков, чертеж земельных участков и их частей, абрисы узловых точек границ земельных участков|схема геодезических построений, схема расположения объекта недвижимости (частей) на земельном участке, чертеж контура объекта недвижимости, план этажа (этажей)|

На техническом плане должны быть отражены размеры всех помещений. Очень важно, чтобы указанные размеры не мешали чтению чертежа. В зависимости от сложности объекта и его размеров схемы могут быть исполнены в масштабе 1:200 или 1:100. Погрешность вычислений с округлением может составить 0,01 м. При вычислении площади с округлением погрешность может быть не более 0,01 квадратных метров.

# Основы технологии дополненной реальности
...
Безмаркерный (он же основанный на положении) ВР использует данные датчиков устройства для оценки положения устройства. Это хороший метод для использования, если ДР должна основываться только на информации, которую получает устройство.
...
# Математические основы для проведения вычислений внутри дополненной реальности
...
1. Выбирается точка, которая будет вершиной первого треугольника
2. Затем выбирается вторая точка, которая будет вершиной второго треугольника
3. Третья точка выбирается таким образом, чтобы она была наиболее удалена от первой и второй точек
4. Этот процесс повторяется до тех пор, пока все точки не будут включены в треугольники

# Технология создания дополненной реальности для мобильных устройств
...
# Анализ Существующих приложений виртуальной реальности
...
# Этапы разработки мобильного приложения дополненной реальности (refactor: remove useless)
...
# Анализ разработанного мобильного приложения дополненной реальности

# Заключение

# Список источников - Спасибо за внимание
